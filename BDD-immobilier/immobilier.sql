...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 30 jan. 2023 à 09:53
...
CREATE TABLE `logement_agence` (
  `id_logementagence` int(5) NOT NULL,
  `id_agence` int(6) NOT NULL,
  `id_logement` int(4) NOT NULL,
...
INSERT INTO `logement_agence` (`id_logementagence`, `id_agence`, `id_logement`, `frais`) VALUES
(1, 257400, 5067, 34250),
(2, 383505, 5067, 30000),
(3, 257400, 5089, 5750),
(4, 692702, 5089, 7623),
...
CREATE TABLE `logement_personne` (
  `id_logementpersonne` int(5) NOT NULL,
  `id_personne` int(3) NOT NULL,
  `id_logement` int(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `logement_personne` (`id_logementpersonne`, `id_personne`, `id_logement`) VALUES
(1, 40, 5067),
(2, 41, 5089),
(3, 42, 5091),
(4, 2, 5122),
...
ALTER TABLE `logement_agence`
  ADD PRIMARY KEY (`id_logementagence`),
...
ALTER TABLE `logement_personne`
  ADD PRIMARY KEY (`id_logementpersonne`),
  ADD KEY `id_personne` (`id_personne`),
  ADD KEY `id_logement` (`id_logement`);
...
--
ALTER TABLE `agence`
  MODIFY `id_agence` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=692703;

--
-- AUTO_INCREMENT pour la table `demande`
--
ALTER TABLE `demande`
  MODIFY `id_demande` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT pour la table `logement`
--
ALTER TABLE `logement`
  MODIFY `id_logement` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5965;

--
-- AUTO_INCREMENT pour la table `logement_agence`
--
ALTER TABLE `logement_agence`
  MODIFY `id_logementagence` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT pour la table `logement_personne`
--
ALTER TABLE `logement_personne`
  MODIFY `id_logementpersonne` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT pour la table `personne`
--
ALTER TABLE `personne`
  MODIFY `id_personne` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
ALTER TABLE `logement_agence`
  ADD CONSTRAINT `logement_agence_ibfk_1` FOREIGN KEY (`id_agence`) REFERENCES `agence` (`id_agence`),
  ADD CONSTRAINT `logement_agence_ibfk_2` FOREIGN KEY (`id_logement`) REFERENCES `logement` (`id_logement`);

--
-- Contraintes pour la table `logement_personne`
--
ALTER TABLE `logement_personne`
  ADD CONSTRAINT `logement_personne_ibfk_1` FOREIGN KEY (`id_logement`) REFERENCES `logement` (`id_logement`),
  ADD CONSTRAINT `logement_personne_ibfk_2` FOREIGN KEY (`id_personne`) REFERENCES `personne` (`id_personne`);
COMMIT;
